...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register as Cashier"} primary={true} style={style} onClick={(event) => this.handleClick(event,'cash')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as Administrator"} primary={true} style={style} onClick={(event) => this.handleClick(event,'admin')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      cashbuttonLabel:'Register as Cashier',
      adminbuttonLabel:'Register as Administrator',
      isLogin:true
    }
  }
  componentWillMount(){
